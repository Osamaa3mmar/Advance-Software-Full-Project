...
anonymousMessagesRouter.post(
	"/send",
	isLogin,
	uploadAttachment.single("attachment"),
	anonymousMessagesController.sendMessage
);
...
anonymousMessagesRouter.post(
	...
	isDoctor,
	uploadAttachment.single("attachment"),
	anonymousMessagesController.replyToMessage
);

// Get all messages (paginated)
anonymousMessagesRouter.get(
	"/all",
	isLogin,
	anonymousMessagesController.getAllMessages
);
...
anonymousMessagesRouter.get(
	...
	isLogin,
	anonymousMessagesController.getConversation
);
...
anonymousMessagesRouter.get(
	...
	isLogin,
	isDoctor,
	anonymousMessagesController.getUnansweredMessages
);
...
anonymousMessagesRouter.get(
	"/search",
	isLogin,
	anonymousMessagesController.searchMessages
);

// Delete message (admin only)
anonymousMessagesRouter.delete(
	"/:messageId",
	isLogin,
	isAdmin,
	anonymousMessagesController.deleteMessage
);
