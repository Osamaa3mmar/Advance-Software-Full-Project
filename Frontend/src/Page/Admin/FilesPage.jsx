...
const CLOUDINARY_BASE_URL =
  import.meta.env.VITE_CLOUDINARY_BASE_URL || "https://res.cloudinary.com/demo";
...
export default function FilesPage() {
  ...
  const [files, setFiles] = useState(initialFakeFiles);
  ...
  const typeOptions = [
    { label: t("admin.files.filterType"), value: null },
    { label: t("admin.files.type.patientRecord"), value: "PATIENT_RECORD" },
    { label: t("admin.files.type.healthGuide"), value: "HEALTH_GUIDE" },
    {
      label: t("admin.files.type.doctorCertificate"),
      value: "DOCTOR_CERTIFICATE",
    },
    { label: t("admin.files.type.other"), value: "OTHER" },
  ];
      ...
      <Card className="border-slate-200">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
            <Button
              label={t("admin.files.allFiles")}
              icon="pi pi-external-link"
              onClick={() =>
                window.open(CLOUDINARY_BASE_URL, "_blank", "noopener")
              }
              severity="secondary"
              outlined
            />
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <Dropdown
            ...
            placeholder={t("admin.files.filterType")}
            showClear
            className="w-full"
          />
        </div>
